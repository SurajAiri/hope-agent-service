...
export class MembershipController {
  addMember = asyncHandler(async (req: Request, res: Response) => {
    ...
    console.log(
      `[MembershipController] addMember called for orgId: ${orgId} by inviterId: ${inviterId} with body:`,
      req.body,
    );
    ...
    console.log(
      `[MembershipController] addMember success for user: ${membership.userId}`,
    );
    res
      .status(201)
  ...
  getMembers = asyncHandler(async (req: Request, res: Response) => {
    ...
    console.log(
      `[MembershipController] getMembers success, found ${members.length} members`,
    );
    res
      .status(200)
  ...
  removeMember = asyncHandler(async (req: Request, res: Response) => {
    ...
    console.log(
      `[MembershipController] removeMember called for orgId: ${orgId}, targetUserId: ${targetUserId} by removerId: ${removerId}`,
    );
  ...
  updateRole = asyncHandler(async (req: Request, res: Response) => {
    ...
    const { role } = req.body;
    console.log(
      `[MembershipController] updateRole called for orgId: ${orgId}, targetUserId: ${targetUserId} to role: ${role}`,
    );
  ...
  leaveOrganization = asyncHandler(async (req: Request, res: Response) => {
    ...
    console.log(
      `[MembershipController] leaveOrganization called for orgId: ${orgId} by userId: ${userId}`,
    );
  ...
  acceptInvite = asyncHandler(async (req: Request, res: Response) => {
    ...
    const userId = req.user!.id as string;
    console.log(
      `[MembershipController] acceptInvite called for orgId: ${orgId} by userId: ${userId}`,
    );
  ...
  rejectInvite = asyncHandler(async (req: Request, res: Response) => {
    ...
    const userId = req.user!.id as string;
    console.log(
      `[MembershipController] rejectInvite called for orgId: ${orgId} by userId: ${userId}`,
    );
